   ...
   <nav class="navbar" id="navbar">
        <div class="nav-container">
            ...
            <div class="nav-menu" id="navMenu">
                <a href="dashboard.php" class="nav-link active" data-section="dashboard">dashboard</a>
                <a href="books.php" class="nav-link" data-section="books">Books</a>
                <a href="notes.php" class="nav-link" data-section="notes">Notes</a>
    ...
    <main id="mainContent">
            ...
            <h1 class="hero-title">Welcome to LittleHUB <u>Dashboard</u></h1>
